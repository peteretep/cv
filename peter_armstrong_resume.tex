...
\resheading{Experience}
    ...
    \item
      ...
      \item
      \ressubheading{Austies Bar and Restaurant}{Sligo, Ireland}{Kitchen Porter}{June 2009 -- June 2010}
        {
        \begin{itemize}
          \resitem{Washing up}
          \resitem{Vegetable preparation}
          \resitem{Cleaning of all areas}
          \resitem{Desserts}
          \resitem{Barman during busy times}
          \resitem{Waiter}
        \end{itemize}
        }
...
\resheading{Interests and Volunteering}
	\begin{description}
    \item[Cooking and Baking:] I regularly bake fresh bread and enjoy making pizza from scratch.
