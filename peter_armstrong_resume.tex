...
\resheading{Education}
    ...
    \item
      ...
      {Sept. 2015 -- Sept. 2016}
        { \footnotesize
        \begin{itemize}
        \resitem{Key Courses: Wind Energy (81\%), Ocean Energy (74\%), Sustainable Energy (77\%), Environmental Impact Assessment (74\%), Offshore Exploration (59\%), Tidal Energy, Marine Renewable Energy, Mechanical Systems, Computational Fluid Dynamics, Solar Energy, Coastal Engineering}
        \end{itemize}
        }
